...
const Contact = () => {
  return (
    ...
    <div className='container mt-5 pt-5 d-flex justify-content-around'>
        ...
        <div>
        <a href=''><img src='https://cdn-icons-png.flaticon.com/512/2111/2111432.png' style={{height:"5rem" }}/></a>
        <h5 className='text-center'>Github</h5>
       </div>
        <div>
        <a href=''><img src='https://cdn-icons-png.flaticon.com/512/3992/3992606.png' style={{height:"5rem" }}/></a>
        <h5 className='text-center'>Linkedin</h5>
        </div>
        <div>
        <a href=''><img src='https://cdn-icons-png.flaticon.com/512/724/724664.png' style={{height:"5rem" }}/></a>
        <h5 className='text-center'>Mobile</h5>
        </div>
        <div>          
        <a href=''> <img src='https://cdn-icons-png.flaticon.com/512/2111/2111463.png' style={{height:"5rem"}}/></a>
